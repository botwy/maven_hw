...
public class OldMain {
    ...
    public static void main(String[] args) {
        OldMain.context = SpringApplication.run(ChatConfig.class, args);
        OldMain.connectionFactory = context.getBean(ConnectionFactory.class);
        OldMain.topic = context.getBean(Topic.class);
